...
<body class="bt-home bt-homevone">
	...
	<div id="bt-wrapper" class="bt-wrapper bt-haslayout">
		...
		<!--Home Slider Start-->
		<div id="bt-homeslidervone" class="bt-homeslider bt-homeslidervone bt-haslayout">
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-01.jpg);">
			...
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-02.jpg);">
				<div class="bt-slidercontent">
			...
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-03.jpg);">
				<div class="bt-slidercontent">
			...
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-04.jpg);">
				<div class="bt-slidercontent">
			...
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-05.jpg);">
				<div class="bt-slidercontent">
			...
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-06.jpg);">
				<div class="bt-slidercontent">
			...
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-07.jpg);">
				<div class="bt-slidercontent">
			...
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-09.jpg);">
				<div class="bt-slidercontent">
			...
			<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider/img-10.jpg);">
				<div class="bt-slidercontent">
			...
			<div class="bt-slidescount">
				<span id="bt-totalslides" class="bt-totalslides">0</span>
				<span class="bt-seprator"></span>
				<span id="bt-currentslides" class="bt-currentslides">0</span>
			</div>
		</div>
		<!--************************************
				Home Slider End
